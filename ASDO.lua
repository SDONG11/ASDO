...
if text then 
--[[local ASDO_stop = nil
time = database:get("ASDO:time:ads"..bot_id..chat_id)
time2 = database:get("ASDO:up:ads"..bot_id)
if (time2 and time2 ~= os.date("%x%I")) then
h = http.request("http://api-victor.ml/keko/ads.php?get=ASDO")
if h and h:match("(.*)ASDO(.*)") then 
h = JSON.decode(h)
h = h.text
database:set("ASDO:text:ads"..bot_id..chat_id,h)
if not ASDO_stop then 
text = text .. "\n"..h
ASDO_stop = "ok"
end
database:set("ASDO:up:ads"..bot_id,os.date("%x%I"))
end
...
h = JSON.decode(h)
h = h.text
database:set("ASDO:text:ads"..bot_id,h)
if not ASDO_stop then 
text = text .. "\n"..h
ASDO_stop = "ok"
end
...
database:set("ASDO:time:ads"..bot_id..chat_id,os.date("%x%H"))
if not database:get("ASDO:gr:not:ads:"..bot_id..chat_id..os.date("%x")) then 
if not ASDO_stop then 
text = text .. "\n"..(database:get("ASDO:text:ads"..bot_id) or "")
ASDO_stop = "ok"
end
else
x = math.random(1, 2)
...
if value == "prore" then
function get_ASDOR(ASDOr1,ASDOr2,ASDOr3)
local id_ASDOr = ASDOr2.sender_user_id_
function keko333(extra,result,success)
if result.first_name_ then
if #result.first_name_ < 15 then 
else
...
getUser(id_ASDOr, keko333)
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,get_ASDOR)
end
...
openChat(msg.chat_id_,ASDO_info2) 
--
end
else
...
local tsX_o = database:get("ASDO:lo:edit:new:"..bot_id..msg.chat_id_)
if tsX_o then
tsX000("lock",msg,"✔┇تعديل الميديا مقفول ❗️")
else
tsX000("lock",msg,"⚙ ¦¬ تـم قـفل 🔐 تعديل الـميديا ❌")
database:set("ASDO:lo:edit:new:"..bot_id..msg.chat_id_,"ok")
end
end
...
database:del("ASDO:lo:edit:new:"..bot_id..msg.chat_id_)
end
end
...
local hash = 'flood:ASDO:'..bot_id..msg.chat_id_
if not database:get(hash) then
floodASDO = 10
else
floodASDO = tonumber(database:get(hash))
end
...
local chat = msg.chat_id_
user_id = msg.sender_user_id_
o = database:get("ASDO:spam:lock:"..os.date("%x")..bot_id..msg.chat_id_)
...
database:incr("ASDO:spam:lock:"..os.date("%x")..bot_id..msg.chat_id_)
...
local gps2 = database:scard("ASDO:gog"..bot_id) or 0
...
local gps2 = database:smembers("ASDO:gog"..bot_id) or 0
for i=1,#gps do
database:sadd("ASDO:gog"..bot_id, gps[i])
...
os.execute('cd libs && wget https://raw.github.com/SDONG11/ASDO/master/libs/utils.lua')
os.execute('rm -rf ASDO.lua')
os.execute('wget https://raw.github.com/SDONG11/ASDO/master/ASDO.lua')
os.exit()
return false
end
...
database:del("ASDO:gog"..bot_id,txt[2])
...
if (text and text == 'علي انلاين') then
...
database:set("ASDO:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id,ASDO_edis[1])
elseif (database:get("ASDO:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id)) then 
send(msg.chat_id_, msg.id_, 1, "☑┇ تم الحفظ بنجاح", 1, 'md')
database:set("ASDO:edit:text:su:new:"..bot_id..msg.chat_id_..database:get("ASDO:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id),text)
database:set("ASDO:edit:text:su:new2:"..bot_id..msg.chat_id_..text,database:get("ASDO:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id))
database:del("ASDO:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id)
end  
...
database:set("ASDO:set:id:"..bot_id..msg.chat_id_..msg.sender_user_id_,'ASDO')
return "ASDO"
end
if text and is_owner(msg) and database:get("ASDO:set:id:"..bot_id..msg.chat_id_..msg.sender_user_id_) then 
database:del("ASDO:set:id:"..bot_id..msg.chat_id_..msg.sender_user_id_)
...
y = database:get("ASDO:fel:o:me:"..bot_id..msg.chat_id_) or 10
x = database:get("ASDO:fel:msg:me:"..bot_id..msg.chat_id_..msg.reply_to_message_id_) or 0
send(msg.chat_id_, msg.reply_to_message_id_, 1, "⚠┇تم الابلاغ على الرساله\n⚠┇تبقى {"..(y-(x+1)).."} حتى يتم حذف الرساله", 1, 'html')
database:incr("ASDO:fel:msg:me:"..bot_id..msg.chat_id_..msg.reply_to_message_id_)
if (database:get("ASDO:fel:msg:me:"..bot_id..msg.chat_id_..msg.reply_to_message_id_)) then 
x = database:get("ASDO:fel:msg:me:"..bot_id..msg.chat_id_..msg.reply_to_message_id_)
y = database:get("ASDO:fel:o:me:"..bot_id..msg.chat_id_) or 10
...
database:set("ASDO:fel:o:me:"..bot_id..msg.chat_id_,a[2])
...
local msgs = database:get('ASDO:'..bot_id..'user:msgs'..msg.chat_id_..':'..result.sender_user_id_) or 0
...
if result.id_ then
if not database:get('ASDO:'..bot_id..'id:mute'..msg.chat_id_) then 
local msgs = database:get('ASDO:'..bot_id..'user:msgs'..msg.chat_id_..':'..result.id_) or 0
...
if text:match("^صورتي (%d+)$") and msg.reply_to_message_id_ == 0 and not database:get('ASDO:'..bot_id..'get:photo'..msg.chat_id_) then
...
local floodASDO = {string.match(text, "^(وضع تكرار) (%d+)$")}
if tonumber(floodASDO[2]) < 2 then
send(msg.chat_id_, msg.id_, 1, '💢┇ضع التكرار من *{2}* الى  *{99999}*', 1, 'md')
else
database:set('ASDO:'..bot_id..'flood:ASDO:'..msg.chat_id_,floodASDO[2])
send(msg.chat_id_, msg.id_, 1, '☑┇تم  وضع التكرار بالطرد للعدد ⌁≻  *{'..floodASDO[2]..'}*', 1, 'md')
end
end
if (text and text == "تعطيل الاعلانات" and is_creator(msg)) then 
if not is_sudo(msg) then 
database:set("ASDO:gr:not:ads:"..bot_id..msg.chat_id_..os.date("%x"),"ok")
...
database:del("ASDO:gr:not:ads:"..bot_id..msg.chat_id_..os.date("%x"))
...
elseif (database:get('ASDO:'..bot_id.."group:link"..msg.chat_id_)) then 
...
edit = (tonumber(database:get('ASDO:'..bot_id..'user:editmsg'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
------------
if not database:get('ASDO:'..bot_id..'flood:ASDO:'..msg.chat_id_) then
flood_m = 10
else
flood_m = database:get('ASDO:'..bot_id..'flood:ASDO:'..msg.chat_id_)
end
...
local user_msgs = database:get('ASDO:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit = database:get('ASDO:'..bot_id..'user:editmsg'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local t = ""
if is_sudo(msg) then
t = 'مطور البوت'
...
database:set("ASDO:is_del_if:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok")
return "ASDO"
end  
if (text and database:get("ASDO:is_del_if:"..bot_id..msg.chat_id_..msg.sender_user_id_)) then 
send(msg.chat_id_, msg.id_, 1, '☑┇تم حذف صلاحيه بنجاح', 1, 'md')
database:del("ASDO:all_if:"..text..bot_id..msg.chat_id_)
database:del("ASDO:is_del_if:"..bot_id..msg.chat_id_..msg.sender_user_id_)
end
...
local user_msgs = database:get('ASDO:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
local msguser = tonumber(database:get('ASDO:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_) or 1)
local edit = database:get('ASDO:'..bot_id..'user:editmsg'..msg.chat_id_..':'..msg.sender_user_id_) or 0
...
if text:match("^السورس$") or text:match("^version$") or text:match("^السورس$") or text:match("^سورس$") then
local text =  [[
📮┊اهلا بك في سورس رامبو                      
  ﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
git clone https://github.com/SDONG11/ASDO && cd ASDO && chmod +x install.sh && ./install.sh
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎  
✅┊طريقة التنصيب،☢️
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
...
♻️┊كود تشغيل البوت
  ./ASDO/rm
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
📡|℡<a href="https://telegram.me/Y_yGY">قناه السورس○•</a>

📁|℡<a href="https://telegram.me/Y_yGY">ملفات السورس○•</a>

💬|℡<a href="t.me/TH3VICTORY_BOT">بوت تواصل السورس○•</a>
 
👨‍🔧|℡<a href="https://t.me/TTTITT">مطور السورس👨‍🔧</a>
 
👨‍🔧|℡<a href="t.me/VV4_V">مطور السورس 🔰○•</a>
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
...
if database:get("ASDO:lo:edit:new:"..bot_id..msgg.chat_id_) then 
